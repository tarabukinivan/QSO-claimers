...
type SyncSwapContracts = {
  router: Hex;
  classicPoolFactory: Hex;
};

export const SYNC_SWAP_CONTRACTS: Record<string, SyncSwapContracts> = {
  zkSync: {
  ...
  scroll: {
    ...
    classicPoolFactory: '0x37BAc764494c8db4e54BDE72f6965beA9fa0AC2d',
  },
  linea: {
    router: '0x80e38291e06339d10AAB483C65695D004dBD5C69',
    classicPoolFactory: '0x37BAc764494c8db4e54BDE72f6965beA9fa0AC2d',
...
export const SYNC_SWAP_ROUTER_ABI = [
  {
    inputs: [
      {
...
export const SYNC_SWAP_CLASSIC_POOL_FACTORY_ABI = [
  {
  ...
  },
  {
    inputs: [],
    name: 'getDeployData',
    outputs: [{ internalType: 'bytes', name: 'deployData', type: 'bytes' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'getSwapFee',
    outputs: [{ internalType: 'uint24', name: 'swapFee', type: 'uint24' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
export const SYNC_SWAP_CLASSIC_POOL_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: '_callbackData', type: 'bytes' },
    ],
    name: 'burn',
    outputs: [
      {
  ...
  },
  {
    inputs: [],
    name: 'getProtocolFee',
    outputs: [{ internalType: 'uint24', name: '_protocolFee', type: 'uint24' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'getSwapFee',
    outputs: [{ internalType: 'uint24', name: '_swapFee', type: 'uint24' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
