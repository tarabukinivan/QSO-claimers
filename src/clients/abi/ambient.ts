export const ambientAbi = [
  {
    inputs: [
      { internalType: 'address', name: 'authority', type: 'address' },
      { internalType: 'address', name: 'coldPath', type: 'address' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint32', name: 'pivotTime', type: 'uint32' },
      { internalType: 'uint64', name: 'feeMileage', type: 'uint64' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint16', name: 'proxyIdx', type: 'uint16' },
      { internalType: 'bytes', name: 'cmd', type: 'bytes' },
