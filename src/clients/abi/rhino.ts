export const rhinoAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: 'token', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
      { indexed: false, internalType: 'string', name: 'withdrawalId', type: 'string' },
    ],
  ...
  { inputs: [], name: 'addFundsNative', outputs: [], stateMutability: 'payable', type: 'function' },
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'to', type: 'address' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
      { internalType: 'string', name: 'withdrawalId', type: 'string' },
    ],
    name: 'withdraw',
    outputs: [],
    stateMutability: 'nonpayable',
